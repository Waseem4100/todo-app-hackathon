...
try:
    ...
    # Upload the final fixes
    files_to_upload = [
        ("D:/Coding/hackathons/todo-app/backend/src/main.py", "src/main.py"),
        ("D:/Coding/hackathons/todo-app/backend/Dockerfile", "Dockerfile"),
        ("D:/Coding/hackathons/todo-app/backend/Procfile", "Procfile")
    ]
    
    print(f"Uploading final fixes to: {repo_id}")
    ...
    print()
    print("[SUCCESS] Final fixes uploaded to https://waseem4100-todoapi2.hf.space!")
    print("Changed to relative imports in main.py and updated Dockerfile/Procfile to run from src directory.")
    print("This should finally resolve the module resolution issue.")
